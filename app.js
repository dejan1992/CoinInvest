...
class UI {
  ...
  addCryptoToList(cryptoRes, nameOfClass) {
    ...
    <td><img src="${cryptoRes.image}"></img></td>
...
async function fetchCrypto() {
  ...
  if (!response.ok) {
    ...
    // const cryptoRes1 = new Cryto(data[0].market_cap_rank, data[0].symbol, data[0].name, data[0].image, data[0].current_price, data[0].market_cap, data[0].circulating_supply, data[0].total_volume, data[0].price_change_24h, data[0].market_cap_change_percentage_24h);
